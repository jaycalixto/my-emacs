...
* Add directories to load-path					  :loadpaths:
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (defun personal-place (suffix)
      "Hides away the actual place where I want to store my personal files.
    This function should be maybe in outside of this repo?"
...
** Slime
   #+begin_src emacs-lisp
     ...
     (add-to-list 'load-path "~/data/repos/slime/")  ; your SLIME directory
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (setq
     ...
     ansi-color-names-vector
          ["black" "red3" "green3" "green2"
           "deep sky blue" "magenta3" "cyan3" "gold"])
...
*** Keybindings							       :keys:
    :PROPERTIES:
    :ID:       93705432-16be-49f0-9916-a121ab90390f
    :END:
    #+BEGIN_SRC emacs-lisp
